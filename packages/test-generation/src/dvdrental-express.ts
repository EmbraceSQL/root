    ...
    this.dispatchMap = {
      "Public.FilmInStock": async (
        ...
        database.Public.FilmInStock(
          request.parameters as Public.Procedures.FilmInStock.Arguments,
        ),
      "Public.FilmNotInStock": async (
        request: EmbraceSQLRequest<object, object>,
      ) =>
        database.Public.FilmNotInStock(
          request.parameters as Public.Procedures.FilmNotInStock.Arguments,
        ),
      "Public.GetCustomerBalance": async (
        request: EmbraceSQLRequest<object, object>,
      ) =>
        database.Public.GetCustomerBalance(
          request.parameters as Public.Procedures.GetCustomerBalance.Arguments,
        ),
      "Public.InventoryHeldByCustomer": async (
        request: EmbraceSQLRequest<object, object>,
      ) =>
        database.Public.InventoryHeldByCustomer(
          request.parameters as Public.Procedures.InventoryHeldByCustomer.Arguments,
        ),
      "Public.InventoryInStock": async (
        request: EmbraceSQLRequest<object, object>,
      ) =>
        database.Public.InventoryInStock(
          request.parameters as Public.Procedures.InventoryInStock.Arguments,
        ),
      "Public.LastDay": async (request: EmbraceSQLRequest<object, object>) =>
        database.Public.LastDay(
          request.parameters as Public.Procedures.LastDay.Arguments,
        ),
      "Public.RewardsReport": async (
        request: EmbraceSQLRequest<object, object>,
      ) =>
        database.Public.RewardsReport(
          request.parameters as Public.Procedures.RewardsReport.Arguments,
        ),
      ...
      "Public.FilmActor.create": async (
        ...
        database.Public.FilmActor.create(
          request.values as Public.Types.FilmActor,
        ),
      ...
      "Public.Address.create": async (
        ...
        database.Public.Address.create(request.values as Public.Types.Address),
      ...
      "Public.City.create": async (
        request: EmbraceSQLRequest<object, object>,
      ) => database.Public.City.create(request.values as Public.Types.City),
      ...
      "Public.Customer.create": async (
        ...
        database.Public.Customer.create(
          request.values as Public.Types.Customer,
        ),
      ...
      "Public.Actor.create": async (
        request: EmbraceSQLRequest<object, object>,
      ) => database.Public.Actor.create(request.values as Public.Types.Actor),
      ...
      "Public.FilmCategory.create": async (
        ...
        database.Public.FilmCategory.create(
          request.values as Public.Types.FilmCategory,
        ),
      ...
      "Public.Inventory.create": async (
        ...
        database.Public.Inventory.create(
          request.values as Public.Types.Inventory,
        ),
      ...
      "Public.Category.create": async (
        ...
        database.Public.Category.create(
          request.values as Public.Types.Category,
        ),
      ...
      "Public.Country.create": async (
        ...
        database.Public.Country.create(request.values as Public.Types.Country),
      ...
      "Public.Language.create": async (
        ...
        database.Public.Language.create(
          request.values as Public.Types.Language,
        ),
      ...
      "Public.Rental.create": async (
        request: EmbraceSQLRequest<object, object>,
      ) => database.Public.Rental.create(request.values as Public.Types.Rental),
      ...
      "Public.Staff.create": async (
        request: EmbraceSQLRequest<object, object>,
      ) => database.Public.Staff.create(request.values as Public.Types.Staff),
      ...
      "Public.Store.create": async (
        request: EmbraceSQLRequest<object, object>,
      ) => database.Public.Store.create(request.values as Public.Types.Store),
      ...
      "Public.Payment.create": async (
        ...
        database.Public.Payment.create(request.values as Public.Types.Payment),
      ...
      "Public.Film.create": async (
        request: EmbraceSQLRequest<object, object>,
      ) => database.Public.Film.create(request.values as Public.Types.Film),
    };
  }
