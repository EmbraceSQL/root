...
export const generateReactComponents = async (context: GenerationContext) => {
  const generationBuffer = [
    ...
    `import { useEmbraceSQLClient, useEmbraceSQLRow, useEmbraceSQLRows, useEmbraceSQLImmutableRows, ChangeEvent, Row as IsRow, RowBase, RecordCallback, GeneratedRowProps } from "@embracesql/react";`,
  ];
