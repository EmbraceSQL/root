  ...
  public Public = new (class implements HasDatabase {
    ...
    public FilmActor = new (class implements HasDatabase {
      ...
      async byActorIdFilmId(
        parameters: schemas.Public.Tables.FilmActor.ByActorIdFilmId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byFilmId(parameters: schemas.Public.Tables.FilmActor.ByFilmId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Address = new (class implements HasDatabase {
      ...
      async byAddressId(parameters: schemas.Public.Tables.Address.ByAddressId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byCityId(parameters: schemas.Public.Tables.Address.ByCityId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public City = new (class implements HasDatabase {
      ...
      async byCityId(parameters: schemas.Public.Tables.City.ByCityId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byCountryId(parameters: schemas.Public.Tables.City.ByCountryId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Customer = new (class implements HasDatabase {
      ...
      async byAddressId(
        parameters: schemas.Public.Tables.Customer.ByAddressId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byCustomerId(
        parameters: schemas.Public.Tables.Customer.ByCustomerId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byLastName(parameters: schemas.Public.Tables.Customer.ByLastName) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byStoreId(parameters: schemas.Public.Tables.Customer.ByStoreId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Actor = new (class implements HasDatabase {
      ...
      async byActorId(parameters: schemas.Public.Tables.Actor.ByActorId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byLastName(parameters: schemas.Public.Tables.Actor.ByLastName) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public FilmCategory = new (class implements HasDatabase {
      ...
      async byFilmIdCategoryId(
        parameters: schemas.Public.Tables.FilmCategory.ByFilmIdCategoryId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    public Inventory = new (class implements HasDatabase {
      ...
      async byInventoryId(
        parameters: schemas.Public.Tables.Inventory.ByInventoryId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byStoreIdFilmId(
        parameters: schemas.Public.Tables.Inventory.ByStoreIdFilmId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    public Category = new (class implements HasDatabase {
      ...
      async byCategoryId(
        parameters: schemas.Public.Tables.Category.ByCategoryId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    public Country = new (class implements HasDatabase {
      ...
      async byCountryId(parameters: schemas.Public.Tables.Country.ByCountryId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Language = new (class implements HasDatabase {
      ...
      async byLanguageId(
        parameters: schemas.Public.Tables.Language.ByLanguageId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ...
    public Rental = new (class implements HasDatabase {
      ...
      async byInventoryId(
        parameters: schemas.Public.Tables.Rental.ByInventoryId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byRentalDateInventoryIdCustomerId(
        parameters: schemas.Public.Tables.Rental.ByRentalDateInventoryIdCustomerId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byRentalId(parameters: schemas.Public.Tables.Rental.ByRentalId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Staff = new (class implements HasDatabase {
      ...
      async byStaffId(parameters: schemas.Public.Tables.Staff.ByStaffId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Store = new (class implements HasDatabase {
      ...
      async byManagerStaffId(
        parameters: schemas.Public.Tables.Store.ByManagerStaffId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byStoreId(parameters: schemas.Public.Tables.Store.ByStoreId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Payment = new (class implements HasDatabase {
      ...
      async byCustomerId(
        parameters: schemas.Public.Tables.Payment.ByCustomerId,
      ) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
      ...
      async byPaymentId(parameters: schemas.Public.Tables.Payment.ByPaymentId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byRentalId(parameters: schemas.Public.Tables.Payment.ByRentalId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byStaffId(parameters: schemas.Public.Tables.Payment.ByStaffId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
    ...
    public Film = new (class implements HasDatabase {
      ...
      async byFilmId(parameters: schemas.Public.Tables.Film.ByFilmId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byFulltext(parameters: schemas.Public.Tables.Film.ByFulltext) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byLanguageId(parameters: schemas.Public.Tables.Film.ByLanguageId) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
      ...
      async byTitle(parameters: schemas.Public.Tables.Film.ByTitle) {
        console.assert(parameters);
        const sql = this.database.context.sql;
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
        const typed = sql.typed as unknown as PostgresTypecasts;
